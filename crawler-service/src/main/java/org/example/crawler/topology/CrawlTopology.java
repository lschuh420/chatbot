package org.example.crawler.topology;
...
import org.example.crawler.bolt.HHNStructuredDataBolt;
import org.example.crawler.bolt.RAGJSONFileWriterBolt;
...
public class CrawlTopology extends ConfigurableTopology {
    ...
    public int run(String[] args) {
        ...
        String[] testURLs = new String[] { "https://www.hs-heilbronn.de/de" };
        ...
        //builder.setBolt("structured", new StructuredDataBolt()).localOrShuffleGrouping("parse");

        //builder.setBolt("enhancedJson", new EnhancedJSONFileWriterBolt("./collected-content")).localOrShuffleGrouping("structured");

        //builder.setBolt("json", new JSONFileWriterBolt("./collected-content")).localOrShuffleGrouping("structured");

        //builder.setBolt("filewriter", new FileWriterBolt("./collected-content")).localOrShuffleGrouping("parse");
